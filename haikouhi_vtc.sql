...
--
-- Hôte : 127.0.0.1:3308
-- Généré le :  lun. 11 fév. 2019 à 16:39
...
--
-- Base de données :  `haikouhi_vtc`
--
CREATE DATABASE IF NOT EXISTS `haikouhi_vtc` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `haikouhi_vtc`;
...
CREATE TABLE IF NOT EXISTS `vehicule` (
  ...
  `immatriculation` varchar(25) COLLATE utf8mb4_unicode_ci NOT NULL,
